...
class SourceAcquisitionService:
    ...
    async def acquire(self, work_version_id: UUID, workspace_id: UUID, doi: str | None = None, title: str | None = None, abstract: str | None = None, trace_id: str = "") -> AcquisitionOutcome:
        ...
        if decision.access_level in (AccessLevel.open_access_full_text, AccessLevel.publisher_open_full_text, AccessLevel.repository_manuscript) and proposed_url:
            try:
                ...
                decision.access_level = AccessLevel.abstract_only if abstract else AccessLevel.metadata_only
