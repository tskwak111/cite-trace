...
async def test_reference_pipeline_and_handler():
    ...
    decisions = [
        (
            ResolutionDecision(
                status="resolved",
                selected_candidate_id=f"{cand1.provider}:{cand1.provider_record_id}",
        ...
        (
            ResolutionDecision(
                status="resolved",
                selected_candidate_id=f"{cand2.provider}:{cand2.provider_record_id}",
                selected_work_version_id=None,
                absolute_score=0.92,
                score_margin=0.1,
                reason_codes=(),
    ...
    outcomes = [
        AcquisitionOutcome(
            ...
            acquisition_method="unpaywall_oa",
            sha256="abc",
            byte_size=100,
            limitations=[],
        ),
